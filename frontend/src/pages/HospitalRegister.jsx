...
export default function HospitalRegister() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden my-8">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-[20%] left-[10%] w-[30rem] h-[30rem] bg-purple-300/20 rounded-full mix-blend-multiply filter blur-[100px] animate-pulse"></div>
